...
var ThemeManager = require('./styles/theme-manager')(); /* Gimi fixed */
...
var Paper = React.createClass({
  ...
  render: function render() {
    ...
    var styles = {
      backgroundColor: (this.context.muiTheme || ThemeManager).component.paper.backgroundColor,
      transition: transitionEnabled && Transitions.easeOut(),
      boxSizing: 'border-box',
      fontFamily: (this.context.muiTheme || ThemeManager).contentFontFamily,
